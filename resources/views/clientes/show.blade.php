    ...
    <div class="card col-8 offset-2">
        <div class="card-body rounded" style="border-radius: 20px;">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <span class="input-group-text" style= "font-size: x-large; background-color: white;">{{$cliente->plan_id}}</span>
                    </div>
            ...
            <div class="form-group">
                <button type="submit" name="action" value="menor" class="btn btn-outline-success">Generar cupon de pago</button>
            </div>
