...
<h2 class="text-center mt-3 mb-4" style="color: #78d278;">Alta menor a cargo</h2>
<div class="container">
            @include('messages')
            <form action="/clienteMenor" method="POST" class="d-flex flex-row align-items-center flex-wrap">
                @csrf
                <div class="row">
                    <div class="col-md-6">
